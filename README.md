...
References:
  ...
  - Observation of quantum entanglement in top quark pair production in proton-proton collisions at $\sqrt{s} = 13 TeV$: https://arxiv.org/abs/2406.03976
</details>
...
Optical/photonic sensors include:
  - Superconducting qubits measuring electromagnetic fields: superconducting transmon qubits dispersively coupled to a microwave cavity, used as single-microwave-photon counters that surpass the standard quantum limit of linear amplification, giving exceptional sensitivity to weak electromagnetic fields.
  ...
  - Squeezed-light interferometers: interferometers in which a squeezed-vacuum quantum state is injected through the signal-output port to reduce the quantum noise floor below the standard quantum limit.
