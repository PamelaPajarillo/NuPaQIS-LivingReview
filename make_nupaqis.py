...
OUTPUT_FILE_NUPA_CATEGORIES = open("BY_NUPA/CATEGORIES.md","w")
...
# OUTPUT_FILE_NUPA_CATEGORIES.write("#  **Descriptions of Nuclear and Particle Physics Topics**\n\n")
# OUTPUT_FILE_NUPA_CATEGORIES.write('**⚠️⚠️⚠️ Warning! LaTeX formatting in GitHub (used in the descriptions) is not functioning properly. Please refer to Section 1.1 in the [PDF version found here](https://docs.google.com/viewer?url=https://raw.githubusercontent.com/PamelaPajarillo/NUPAQIS-LivingReview/main/NUPAQIS.pdf) ⚠️⚠️⚠️**\n\n')
# OUTPUT_FILE_NUPA_CATEGORIES.write("[![NUPACAT_TO_NUPA](https://img.shields.io/badge/Link_to-Living_Review_by_NUPA_-5BC0EB)](/BY_NUPA#a-living-review-of-quantum-information-science-in-high-energy-physics-organized-by-hep-topics) \t\n")
# OUTPUT_FILE_NUPA_CATEGORIES.write("[![NUPACAT_TO_QIS](https://img.shields.io/badge/Link_to-Living_Review_by_QIS_-9BC53D)](/BY_QIS#a-living-review-of-quantum-information-science-in-high-energy-physics-organized-by-qis-topics) \t\n")
# OUTPUT_FILE_NUPA_CATEGORIES.write("[![NUPACAT_TO_MAIN](https://img.shields.io/badge/Link_to-Living_Review_Home_-FDE74C)](/../../#readme) \n\n")
list_subcategories_to_md(OUTPUT_FILE_MAIN, OUTPUT_FILE_NUPA_CATEGORIES, categories_hep, df_csv_hep, "NUPA")

# ***** QIS CATEGORIES -----------------------------------------------------------------------
OUTPUT_FILE_MAIN.write("##  **Quantum Information Science (QIS) Topics**\n\n")
# OUTPUT_FILE_QIS_CATEGORIES.write("#  **Descriptions of Quantum Information Science Topics**\n\n")
...
# OUTPUT_FILE_QIS_CATEGORIES.write("[![QISCAT_TO_NUPA](https://img.shields.io/badge/Link_to-Living_Review_by_NUPA_-5BC0EB)](/BY_NUPA#a-living-review-of-quantum-information-science-in-high-energy-physics-organized-by-hep-topics) \t\n")
# OUTPUT_FILE_QIS_CATEGORIES.write("[![QISCAT_TO_QIS](https://img.shields.io/badge/Link_to-Living_Review_by_QIS_-9BC53D)](/BY_QIS#a-living-review-of-quantum-information-science-in-high-energy-physics-organized-by-qis-topics) \t\n")
...
# OUTPUT_FILE_NUPA_CATEGORIES.close()
# OUTPUT_FILE_QIS_CATEGORIES.close()

# ***** BY NUPA MD -----------------------------------------------------------------------
OUTPUT_FILE_NUPA.write("#  **A Living Review of Quantum Information Science in Nuclear and Particle Physics Organized by Nuclear and Particle Physicsd Topics**\n\n")
OUTPUT_FILE_NUPA.write('**⚠️⚠️⚠️ Warning! LaTeX formatting in GitHub (used in the descriptions of each paper) is not functioning properly. Please refer to Section 2 in the [PDF version found here](https://docs.google.com/viewer?url=https://raw.githubusercontent.com/PamelaPajarillo/NUPAQIS-LivingReview/main/NUPAQIS.pdf) ⚠️⚠️⚠️**\n\n')
OUTPUT_FILE_NUPA.write("[![BY_QIS](https://img.shields.io/badge/Link_to-Living_Review_by_QIS-9BC53D)](/BY_QIS#a-living-review-of-quantum-information-science-in-high-energy-physics-organized-by-qis-topics) \t\n")
OUTPUT_FILE_NUPA.write("[![NUPA_TO_MAIN](https://img.shields.io/badge/Link_to-Living_Review_Home_-FDE74C)](/../../#readme) \n\n")

write_papers_to_md(df, OUTPUT_FILE_NUPA, categories_hep, categories_qis, "NUPA", "QIS")
...
OUTPUT_FILE_QIS.write("[![QIS_TO_NUPA](https://img.shields.io/badge/Link_to-Living_Review_by_NUPA-5BC0EB)](/BY_NUPA#a-living-review-of-quantum-information-science-in-high-energy-physics-organized-by-hep-topics) \t\n")
OUTPUT_FILE_QIS.write("[![QIS_TO_MAIN](https://img.shields.io/badge/Link_to-Living_Review_Home_-FDE74C)](/../../#readme) \n\n")

write_papers_to_md(df, OUTPUT_FILE_QIS, categories_qis, categories_hep, "QIS", "NUPA")
...
# ***** MAIN LATEX FILES -----------------------------------------------------------------------
# write_categories_to_tex(OUTPUT_FILE_CATEGORIES, categories_hep, df_csv_hep, "NUPA")
# write_categories_to_tex(OUTPUT_FILE_CATEGORIES, categories_qis, df_csv_qis, "QIS")
write_papers_to_tex(df, OUTPUT_FILE_NUPA, categories_hep, categories_qis, "NUPA", "QIS")
write_papers_to_tex(df, OUTPUT_FILE_QIS, categories_qis, categories_hep, "QIS", "NUPA")
